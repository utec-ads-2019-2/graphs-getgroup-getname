#ifndef GRAPHS_GETGROUP_GETNAME_BASIC_PARSERD_H
#define GRAPHS_GETGROUP_GETNAME_BASIC_PARSERD_H
#include <utility>

#include "Basic_class.h"

class Basic_Parser_D {
    string archivo;
public:
    explicit Basic_Parser_D(string archivo) : archivo(std::move(archivo)) {}
    ...
    Graph<String_class> Generate_Graph(){
        ...
        Graph<String_class> Graph1(Map_for_graph, true);
    ...
    ~Basic_Parser_D()= default;
};


#endif //GRAPHS_GETGROUP_GETNAME_BASIC_PARSERD_H
