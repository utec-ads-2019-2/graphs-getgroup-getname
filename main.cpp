...
int main() {
    ...
    //cout<<Grafo_1.Find_edge("F","2")<<Grafo_1.Find_edge("2","F");
    //cout<<endl<<Grafo_1.Get_Density()<<endl;


    cout<<Grafo_1.Find_edge("2","F")<<Grafo_1.Find_edge("zz","Fz")<<Grafo_1.Find_edge("F","2");
    ...
    cout<<"\n\n\n";
    Grafo_2.Kruskal();
    Grafo_2.Agregar_Vertice("t",String_class("t"));
